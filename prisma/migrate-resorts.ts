...
async function main() {
  ...
  // Apartment types now come from migrate/apt_category.txt (Informix apt_category)
  // via prisma/migrate-apt-category.ts, which supersedes the 9 business-supplied rows
  // that used to be hardcoded here. Run that script after this one.
