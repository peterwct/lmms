...
import rciEnrolmentRoutes from './routes/rciEnrolments';
import rciWeekRoutes     from './routes/rciWeeks';
import rciBulkBankRoutes from './routes/rciBulkBank';
...
app.use('/api/rci-enrolments',    rciEnrolmentRoutes);
app.use('/api/rci-weeks',         rciWeekRoutes);
app.use('/api/rci-bulk-bank',     rciBulkBankRoutes);
